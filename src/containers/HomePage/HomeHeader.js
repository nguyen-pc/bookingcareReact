...
import LeftModal from '../Patient/Doctor/Modal/LeftModal';
class HomeHeader extends Component {

    constructor(props){
        super(props)
        this.state ={
            isComponenetMenuVisisble : false,
        }
    }
    ...
    render() {
        ...
        <React.Fragment>
            <div className='home-header-container'> 
                    <div className='home-header-content'>
                        <div className='left-content'>
                            <i className="fas fa-bars " onClick={this.toggleComponentMenu}></i>
            ...
            <div className='home-header-banner'>
                ...
                {this.state.isComponenetMenuVisisble && <LeftModal/>}  
            </div>
