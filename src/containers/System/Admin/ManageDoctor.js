...
class ManageDoctor extends Component {
  ...
  componentDidUpdate(prevProps, prevState, snapshot) {
    ...
    if(prevProps.allRequiredDoctorInfo !== this.props.allRequiredDoctorInfo){
      ...
      console.log('data', dataSelectProvince,dataSelectPrice,dataSelectPayment)
      this.setState({
  ...
  handleChangeSelect = async (selectedOption , name) => {
    ...
    if(res && res.errCode===0 && res.data && res.data.Markdown){
        ...
        let addressClinic='', nameClinic='', note='',paymentId='',priceId='',specialtyId='',clinicId=''
        ,provinceId='', selectedPayment='',selectedPrice='', selectedProvince='',selectedClinic='',
        selectedSpecialty='';
        ...
        if(res.data.Doctor_Info){
         ...
         console.log('selectedClinic',selectedProvince)
